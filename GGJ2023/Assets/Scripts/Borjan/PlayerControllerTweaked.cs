...
namespace TarodevController {
    ...
    /// </summary>
    public class PlayerControllerTweaked : MonoBehaviour, IPlayerController {
        ...
        private void CalculateJump() {
            ...
            if (Input.JumpDown && CanUseCoyote || HasBufferedJump || (Input.JumpDown && timesJumped < PlayerStats.instance.stats.GetNumberOfJumps()) ) {
                timesJumped++;
                //Debug.Log(timesJumped + " : " + PlayerStats.instance.stats.GetNumberOfJumps());
